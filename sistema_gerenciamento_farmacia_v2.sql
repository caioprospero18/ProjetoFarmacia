...
START TRANSACTION;
USE `sistema_gerenciamento_farmacia`;
INSERT INTO `sistema_gerenciamento_farmacia`.`tipo_usuario` (`codigo_tipo`, `nome`, `modulo_administrativo`, `modulo_venda`, `modulo_cadastro_receita`) VALUES (1, 'Administrador', NULL, NULL, NULL);
INSERT INTO `sistema_gerenciamento_farmacia`.`tipo_usuario` (`codigo_tipo`, `nome`, `modulo_administrativo`, `modulo_venda`, `modulo_cadastro_receita`) VALUES (2, 'Gerente', NULL, NULL, NULL);
INSERT INTO `sistema_gerenciamento_farmacia`.`tipo_usuario` (`codigo_tipo`, `nome`, `modulo_administrativo`, `modulo_venda`, `modulo_cadastro_receita`) VALUES (3, 'Caixa', NULL, NULL, NULL);
INSERT INTO `sistema_gerenciamento_farmacia`.`tipo_usuario` (`codigo_tipo`, `nome`, `modulo_administrativo`, `modulo_venda`, `modulo_cadastro_receita`) VALUES (4, 'Atendente', NULL, NULL, NULL);
...
START TRANSACTION;
USE `sistema_gerenciamento_farmacia`;
INSERT INTO `sistema_gerenciamento_farmacia`.`produtos` (`codigo_produto`, `nome_produto`, `valor_produto`, `quantidade_estoque`, `tarja`, `receita`, `codigo_categoria`) VALUES (15, 'Benegripe', 17.89, 8, NULL, NULL, 2);
...
INSERT INTO `sistema_gerenciamento_farmacia`.`produtos` (`codigo_produto`, `nome_produto`, `valor_produto`, `quantidade_estoque`, `tarja`, `receita`, `codigo_categoria`) VALUES (17, 'Shampoo do CR7', 28.9, 26, NULL, NULL, 1);
INSERT INTO `sistema_gerenciamento_farmacia`.`produtos` (`codigo_produto`, `nome_produto`, `valor_produto`, `quantidade_estoque`, `tarja`, `receita`, `codigo_categoria`) VALUES (54, 'Dipirona', 5.47, 89, NULL, NULL, 2);
