...
public class JFrameConsultaProduto extends javax.swing.JFrame {
    ...
    private String query = "SELECT codigo_produto as ID, nome_produto as Produto, quantidade_estoque as Quantidade_Em_Estoque,"
            + " tarja as Tarja, receita as Receita, codigo_categoria as Categoria FROM produtos";
    private ResultSetTableModel result;//para trazer o resultado da query
    private final TableRowSorter< TableModel > filter;
    
    public JFrameConsultaProduto(Produto produto, boolean select, boolean disconnectOnClose) throws SQLException {
        initComponents();
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if( row != -1){
            ...
            this.produto.setCodigoProduto(codigo);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if( row != -1){
            ...
            try{
                ...
                crud = new JFrameCRUDProduto(produto/*já possui dados*/, false);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try{
                    new JFrameConsultaProduto(null, false, true).setVisible(true);
                }catch (Exception ex){
                    ex.printStackTrace();
                }
            }
