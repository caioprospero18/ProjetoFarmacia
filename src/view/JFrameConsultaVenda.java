...
public class JFrameConsultaVenda extends javax.swing.JFrame {
    ...
    private String query = "SELECT codigo_tipo as ID, nome as Nome_Tipo FROM vendas";
    private ResultSetTableModel result;//para trazer o resultado da query
    private final TableRowSorter< TableModel > filter;

    public JFrameConsultaVenda(Venda venda, boolean select, boolean disconnectOnClose) throws SQLException {
        initComponents();
    ...
    private void initComponents() {
        ...
        setTitle("Consulta de vendas realizadas");
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if( row != -1){
            ...
            this.venda.setCodigoVenda(codigo);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaVenda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try{
                new JFrameConsultaVenda(null, false, true).setVisible(true);
                } catch(Exception ex){
                    ex.printStackTrace();
                }
            }
