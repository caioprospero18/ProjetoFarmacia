...
public class JFrameConsultaReceita extends javax.swing.JFrame {
    ...
    private String query = "SELECT r.codigo_receita as ID, nome_medico as Medico,"
            + " r.crm as CRM, r.cor as Cor, u.nome_completo as Cliente, p.nome_produto as Remedio FROM receitas r join usuarios u join produtos p";
    ...
    private void initComponents() {
        ...
        setTitle("Consulta de receitas cadastradas");
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if( row != -1){
            ...
            this.receita.setCodigoReceita(codigo);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if( row != -1){
            ...
            receita = new Receita();
            receita.setCodigoReceita(codigo);
            try{
                receita.load();
                
                JFrameCRUDReceita crud;
                crud = new JFrameCRUDReceita(receita/*já possui dados*/, false);
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        JFrameCRUDReceita crud;
        crud = new JFrameCRUDReceita(null/*janela de adicionar não tem dados para passar*/, false);
        crud.addWindowListener( new java.awt.event.WindowAdapter() {
            @Override
            //metodo para atualizar a tabela ao fechar a Janela CRUD
            public void windowClosed( java.awt.event.WindowEvent evt){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaReceita.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
