...
public class JFrameConsultaTipo extends javax.swing.JFrame {
    ...
    private String query = "SELECT codigo_tipo as ID, nome as Nome_Tipo FROM tipo_usuario";
    private ResultSetTableModel result;//para trazer o resultado da query
    private final TableRowSorter< TableModel > filter;

    public JFrameConsultaTipo(TipoUsuario tipo, boolean select, boolean disconnectOnClose) throws SQLException {
        initComponents();
    ...
    private void jButtonSelecionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSelecionarActionPerformed
        ...
        if( row != -1){
            ...
            this.tipo.setCodigoTipo(codigo);
    ...
    private void jButtonAlterarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAlterarActionPerformed
        ...
        if( row != -1){
            ...
            tipo.setCodigoTipo(codigo);
            try{
                tipo.load();
                
                JFrameCRUDTipo crud;
                crud = new JFrameCRUDTipo(tipo/*já possui dados*/, false);
    ...
    private void jButtonAdicionarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAdicionarActionPerformed
        ...
        JFrameCRUDTipo crud;
        crud = new JFrameCRUDTipo(null/*janela de adicionar não tem dados para passar*/, false);
        crud.addWindowListener( new java.awt.event.WindowAdapter() {
            @Override
            //metodo para atualizar a tabela ao fechar a Janela CRUD
            public void windowClosed( java.awt.event.WindowEvent evt){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameConsultaTipo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                try{
                    new JFrameConsultaTipo(null, false, true).setVisible(true);
                }catch(Exception ex){
                    ex.printStackTrace();
                }
            }
